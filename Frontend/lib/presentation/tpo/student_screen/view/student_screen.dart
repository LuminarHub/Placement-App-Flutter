...
class _StudentScreenState extends State<StudentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // )),
      body: FutureBuilder(
          future: Provider.of<TPOManageStudentController>(context, listen: false).fetchStudentList(context),
                  ...
                  return tmsControl.tpoManageStudentModel.data == null ||
                      ...
                      : Padding(
                          ...
                          child: ListView.builder(
                            itemCount: tmsControl.tpoManageStudentModel.data?.length,
                            itemBuilder: (context, index) {
                              ...
                              //   phone: "${tmsControl.tpoManageStudentModel.data?[index].phoneNo}",
                              //   username: '${tmsControl.tpoManageStudentModel.data?[index].username}',
