  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
            future: Provider.of<InterviewController>(context, listen: false).fetchData(context),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Consumer<InterviewController>(
                  builder: (context, iControl, child) {
                    return iControl.interviewModel.data == null || iControl.interviewModel.data!.isEmpty
                        ? Center(
                            child: Text(
                              "No Data Found",
                              style:
                              ...
                              return Card(
                                  ...
                                  child: ListTile(
                                    title: Column(
                                      ...
                                      children: [
                                        Text("Date : ${iControl.interviewModel.data?[index].dateTime}"),
                                        Text("Place : ${iControl.interviewModel.data?[index].location}")
                                      ],
                                    ),
                                    subtitle: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      ...
                                      children: [
                                        ...
                                        Text("Company Id : ${iControl.interviewModel.data?[index].company}")
                                      ],
                                    ),
                                  ));
                            });
